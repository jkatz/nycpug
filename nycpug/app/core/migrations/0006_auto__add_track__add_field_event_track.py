...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_track', (
            ...
            ('conference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tracks', to=orm['core.Conference'])),
        ...
        db.add_column(u'core_event', 'track',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Track'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_event', 'track_id')
