...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsorCategory.css_class'
        db.add_column(u'core_sponsorcategory', 'css_class',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsorCategory.css_class'
        db.delete_column(u'core_sponsorcategory', 'css_class')
