...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.is_call_for_papers_active'
        db.add_column(u'core_conference', 'is_call_for_papers_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Conference.is_schedule_active'
        db.add_column(u'core_conference', 'is_schedule_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conference.is_call_for_papers_active'
        db.delete_column(u'core_conference', 'is_call_for_papers_active')

        # Deleting field 'Conference.is_schedule_active'
        db.delete_column(u'core_conference', 'is_schedule_active')
