...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_schedule', (
            ...
            ('proposal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Proposal'], null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='schedules', null=True, to=orm['core.Room'])),
            ('entire_space', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
