...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.event_bio'
        db.add_column(u'core_event', 'event_bio',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        db.execute("""UPDATE core_event e
                        SET event_bio = account_profile.description
                        FROM core_proposal, account_profile
                        WHERE e.proposal_id = core_proposal.id AND core_proposal.user_id = account_profile.user_id""")


    def backwards(self, orm):
        # Deleting field 'Event.event_bio'
        db.delete_column(u'core_event', 'event_bio')
