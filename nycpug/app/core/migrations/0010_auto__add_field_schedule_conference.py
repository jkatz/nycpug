...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Schedule.conference'
        db.add_column('core_schedule', 'conference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Conference'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Schedule.conference'
        db.delete_column('core_schedule', 'conference_id')
    ...
    models = {
        ...
        'core.schedule': {
            ...
            'conference': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Conference']", 'null': 'True'}),
