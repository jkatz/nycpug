...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sponsor.sort_order'
        db.add_column('sponsor_sponsor', 'sort_order', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sponsor.sort_order'
        db.delete_column('sponsor_sponsor', 'sort_order')
